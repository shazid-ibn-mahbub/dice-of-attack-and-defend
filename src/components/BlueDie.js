...
const BlueDie = () => {
  ...
  const dieRotateAnimationFace = () => {
    if (playerRoll.blueDieScoreRepeatCount % 2 === 1) {
      switch (playerRoll.blueDieScore) {
        case 1:
...
const BlueDieContainer = styled(motion.div)`
  height: 10rem;
  width: 10rem;
  position: relative;
